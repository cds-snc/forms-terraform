...
dependency "rds" {
  ...
  mock_outputs = {
    ...
    rds_db_name                        = null
    database_connection_url_secret_arn = "database_connection_url_secret_arn"
  }
}
...
dependency "dynamodb" {
  ...
  mock_outputs = {
    ...
    dynamodb_reliability_queue_name    = "ReliabilityQueue"
...
inputs = {
  ...
  dynamodb_reliability_queue_name    = dependency.dynamodb.outputs.dynamodb_reliability_queue_name
