...
You will need to create a Localstack account using your CDS email address and then ask your supervisor to assign you a Pro license license.
...
Once Localstack is ready to use you should be able to interact with local AWS services using the [Localstack web application](https://app.localstack.cloud/dashboard).
