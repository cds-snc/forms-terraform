...
if aws kms list-keys | grep -q "KeyArn"; then
  printf "${yellowColor}=> Detected old development instance. Will use existing Terraform state files to update resources...${reset}\n"
else
