...
export function lambdaWithContextualLogger<Input, Output>(handler: (params: { event: Input; context: Context; contextualLogger: LambdaInvocationContextualLogger }) => EitherAsync<Error, Output>) {
