locals {
  ...
  platform_forms_client_post_deployment = "platform-forms-client-post-deployment"
}
...
resource "aws_iam_role_policy_attachment" "platform_forms_client_post_deployment" {
  role       = local.platform_forms_client_post_deployment
  policy_arn = aws_iam_policy.platform_forms_client_post_deployment.arn
