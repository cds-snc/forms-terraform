resource "aws_lambda_function" "prisma_migration" {
  ...
  environment {
    variables = {
      DB_URL_SECRET_ARN     = var.database_connection_url_secret_arn // This lambda is not used anymore and will be removed in https://github.com/cds-snc/forms-terraform/pull/1303
