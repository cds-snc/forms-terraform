...
module.exports = async (submissionID, sendReceipt, formSubmission, formID, message, submissionDateTime) => {
  ...
  return await copyFilesFromReliabilityToVaultStorage(fileInputPaths)
    ...
    .then(async () => await saveToVault(submissionID, formSubmission.responses, formID, submissionDateTime))
    .catch((err) => {
